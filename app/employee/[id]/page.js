    ...
    <main className="p-6 max-w-4xl mx-auto">
      ...
      >
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 text-sm">
          ...
          <p>
            <strong>Eye Color:</strong> {employee.eyeColor}
          </p>
          <p>
            <strong>Height:</strong> {employee.height} cm
          </p>
          <p>
            <strong>Weight:</strong> {employee.weight} kg
          </p>
          <p>
        ...
        <div>
          ...
          <p>
            {employee.bank.cardType} - ****{employee.bank.cardNumber.slice(-4)}{" "}
            (Exp: {employee.bank.cardExpire})
          </p>
        </div>
        ...
        <div>
          ...
          <p>
            {employee.crypto.coin} on {employee.crypto.network}
          </p>
          ...
          <div className="flex items-center gap-1">
            {[...Array(5)].map((_, i) => (
              <span
                key={i}
                className={
                  i < employee.performance ? "text-yellow-400" : "text-gray-300"
                }
              >
                ★
              </span>
        ...
        <div className="mt-6">
          ...
          >
            <div className="text-sm border-t pt-4">
              {activeTab === "Overview" && (
                <p>
                  This is an overview tab. You can add charts, summaries, or
                  team affiliations here.
                </p>
              )}
              {activeTab === "Projects" && (
